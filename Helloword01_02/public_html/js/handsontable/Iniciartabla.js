...
angular.module("miApp", []).controller("tabla", function ($scope, $http) {
    ...
    $http.get('/EmpleadosInactivos/' + vars.periodo).then(function (inactivos) {
        var empleados = [];
        for (var i in inactivos.data) {
            empleados.push(inactivos.data[i].cedula);
        }
        ...
        $scope.iniciar = function () {
            /*SIMULACION LOCAL*/
            $http.get('/Empleados/' + vars.periodo).then(function (d) {
